...
public class ViewRelojSegundo extends View {
	...
	public ViewRelojSegundo(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		canvas.drawBitmap(sec,mat,paint);
	...
	public void changePercentage(int percent, int hora){
