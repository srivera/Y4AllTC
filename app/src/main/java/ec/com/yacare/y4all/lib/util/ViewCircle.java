...
//		textSize = ta.getFloat(R.styleable.CircleRoadProgressWidget_textSize, 20f);
	...
	//	paint.setColor(Color.YELLOW);
		...
		canvas.drawArc(box, sweep - 103, 13, false, paint);
	}
	...
	private void drawPercents(Canvas canvas){
		...
		canvas.drawText(texto, positionX, positionY, textPaint);
	}

	String texto = "";
	public void changePercentage(int percent, String texto, int color, int colorLinea, float textSize){
		this.percent = percent;
		this.texto = texto;
		this.textColor = color;
		this.textSize = textSize;
		roadInnerCircleColor = colorLinea;
		arcLoadingColor= colorLinea;
