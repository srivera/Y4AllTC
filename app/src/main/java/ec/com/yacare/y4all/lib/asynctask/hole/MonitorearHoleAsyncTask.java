...
public class MonitorearHoleAsyncTask extends AsyncTask<String, Float, String> {

	
	private MonitorIOActivity monitorIOActivity;
	

	public MonitorearHoleAsyncTask(MonitorIOActivity monitorIOActivity) {
		super();
	...
	protected String doInBackground(String... arg0) {
		...
		HttpPost httppost = new HttpPost(YACSmartProperties.URL_MONITOREAR_HOLE);
		httppost.setHeader("content-type", "application/x-www-form-urlencoded");

		String respStr = "";
		try {
			String json = "{\"monitorearHolePunshing\":{\"numeroSerie\":\"" + datosAplicacion.getEquipoSeleccionado().getNumeroSerie()
	...
	protected void onPostExecute(String respuesta) {
		monitorIOActivity.verificarResultadoDirecto(respuesta);
	}
