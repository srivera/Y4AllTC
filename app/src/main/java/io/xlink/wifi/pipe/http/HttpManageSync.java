 ...
 */
public class HttpManageSync {

    private static HttpManageSync instance;
...
//    public final String upgradeUrl = host + "/v1/user/device/version";
    ...
    public static HttpManageSync getInstance() {
        if (instance == null) {
            instance = new HttpManageSync();
        }
        return instance;
    }
     ...
     * @param pwd  密码
     */
    public void registerUserByMail(String mail, String name, String pwd, final ResultCallbackSync callback) {
     ...
     * @param pwd  密码
     */
    public void login(String mail, String pwd, final ResultCallbackSync callback) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("email", mail);
        params.put("corp_id", COMPANY_ID);
        params.put("password", pwd);
     ...
     */
    public void getShareList(final ResultCallbackSync callback) {
        Map<String, String> headers = new HashMap<String, String>();
        headers.put("Access-Token", DatosAplicacion.getApp().getAccessToken());
     ...
     * 11.获取用户详细信息
     */
    public void getUserInfo(int userId, final ResultCallbackSync callback) {
     ...
     * 11.获取用户详细信息
     */
    public void getDatapoints(String pid, final ResultCallbackSync callback) {
     ...
     * @param mail 用户 邮箱
     */
    public void forgetPasswd(String mail, final ResultCallbackSync callback) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("email", mail);
        params.put("corp_id", COMPANY_ID);
     ...
     * @param mail 用户 邮箱
     */
    public void shareDevice(String mail, int deviceId, final ResultCallbackSync callback) {
        Map<String, String> params = new HashMap<String, String>();
     ...
     */
    public void denyShare(String inviteCode, final ResultCallbackSync callback) {
        Map<String, String> params = new HashMap<String, String>();
     ...
     * @param userId userId
     */
    public void subscribe(String userId, String productId, int deviceId, final ResultCallbackSync callback) {
     ...
     * @param userId userId
     */
    public void unsubscribe(int userId,  int deviceId, final ResultCallbackSync callback) {
     ...
     * @param userId userId
     */
    public void modifyUser(int userId, String nickname, final ResultCallbackSync callback) {
     ...
     * .重置密码
     */
    public void resetPassword(String newPasswd, String oldPasswd, final ResultCallbackSync callback) {
        Map<String, String> params = new HashMap<String, String>();
     ...
     * @param inviteCode 分享ID
     */
    public void acceptShare(String inviteCode, final ResultCallbackSync callback) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("invite_code", inviteCode);
        Map<String, String> headers = new HashMap<String, String>();
        headers.put("Access-Token", DatosAplicacion.getApp().getAccessToken());
     ...
     * @param deviceId 设备ID
     */
    public void getDevice(String productIdd, int deviceId, final ResultCallbackSync callback) {
     ...
     * http //.获取某个用户绑定的设备列表。
     */
    public void getSubscribeList(int uid, int versionid, final ResultCallbackSync callback) {
     ...
     * http //.获取某个用户绑定的设备列表。
     */
    public void deleteShare(String inviteCode, final ResultCallbackSync callback) {
...
//=========================================================================================
    ...
    private void post(String url, Map<String, String> params, ResultCallbackSync callback) {
        // 请求entity
        StringEntity entity = params2StringEntity(params);
        client.post(DatosAplicacion.getApp(), url, entity, "application/json", callback);
    }

    private void get(String url, Map<String, String> headers, ResultCallbackSync callback) {
        Header[] headersdata = map2Header(headers);
        client.get(DatosAplicacion.getApp(), url, headersdata, null, callback);
    }

    private void delete(String url, Map<String, String> headers, ResultCallbackSync callback) {
        Header[] headersdata = map2Header(headers);
        client.delete(DatosAplicacion.getApp(), url, headersdata, null, callback);
    }

    private void post(String url, Map<String, String> headers, Map<String, String> params, ResultCallbackSync callback) {
        // 请求entity
        StringEntity entity = params2StringEntity(params);
        Header[] headersdata = map2Header(headers);
        client.post(DatosAplicacion.getApp(), url, headersdata, entity, "application/json", callback);
    }

    private void put(String url, Map<String, String> headers, Map<String, String> params, ResultCallbackSync callback) {
        // 请求entity
        StringEntity entity = params2StringEntity(params);
        Header[] headersdata = map2Header(headers);
        client.put(DatosAplicacion.getApp(), url, headersdata, entity, "application/json", callback);
    }
    ...
    public static abstract class ResultCallbackSync<T> extends TextHttpResponseHandler {
        Type mType;
        private Gson mGson;

        public ResultCallbackSync() {
        ...
        public void onFailure(int code, Header[] headers, String msg, Throwable throwable) {
            if (code > 0) {
                try {
                    ErrorEntitySync errorEntity = mGson.fromJson(msg, ErrorEntitySync.class);
                    onError(headers, errorEntity.error);
                } catch (Exception e) {
                    ErrorEntitySync errorEntity = new ErrorEntitySync();
        ...
        public abstract void onError(Header[] headers, ErrorSync error);

        public abstract void onSuccess(int code, T response);
    }


    public static class ErrorSync {
        private int code;
        private String msg;
    ...
    private static class ErrorEntitySync {
        public ErrorSync error;

        public ErrorEntitySync() {
            error = new ErrorSync();
        }
    }
}
