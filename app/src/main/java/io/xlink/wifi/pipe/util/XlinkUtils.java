...
public class XlinkUtils {
	...
	ConnectivityManager connectivity = (ConnectivityManager) DatosAplicacion.getApp()
	...
	ConnectivityManager cm = (ConnectivityManager) DatosAplicacion.getApp()
		.getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	//Log.e("Tips", tip);
	//Toast.makeText(DatosAplicacion.getApp(), tip, Toast.LENGTH_SHORT).show();
    }

    public static void longTips(String tip) {
	Toast.makeText(DatosAplicacion.getApp(), tip, Toast.LENGTH_LONG).show();
    }
